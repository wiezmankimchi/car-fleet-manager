...
import MainCardSection from 'src/components/MainCardSection/MainCardSection'
import MainTopSection from 'src/components/MainTopSection/MainTopSection'
import MainTransactionSectionHeader from 'src/components/MainTransactionSectionHeader/MainTransactionSectionHeader'
      ...
      <div>
        ...
        <div className="flex overflow-hidden bg-white pt-16">
          ...
          >
            <main>
              <div className="px-4 pt-6">
                ...
                <div className="mt-4 grid w-full grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
                  ...
                  <MainCardSection
                    cardvalue={5355}
                    cardtext="Visitors this week"
                    cardpercent={32.9}
                    cardup
                  />
                  <MainCardSection
                    cardvalue={385}
                    cardtext="User signups this week"
                    cardpercent={2.7}
                    cardup={false}
                  />
                </div>
                          ...
                          <tr className="text-gray-500">
                            ...
                            <td className="whitespace-nowrap border-t-0 p-4 px-4 align-middle text-xs">
                              <div className="flex items-center">
                                ...
                                <div className="relative w-full">
                                  <div className="h-2 w-full rounded-sm bg-gray-200"></div>
            ...
            <footer className="my-6 mx-4 rounded-lg bg-white p-4 shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8">
